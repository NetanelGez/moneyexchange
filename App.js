      ...
      <Router>
        ...
        <Switch>
          <Route exact path="/">
            ...
            {disabled ? (
              <button onClick={coinsValue} disabled>
                Start
              </button>
            ) : (
              <button onClick={coinsValue}>Start</button>
            )}
            ...
            <button onClick={() => setShowHis(!showHis)}>History</button>
          ...
          <Route
            ...
            path="/update"
            component={() => {
              return <Update coins={coins} addCoin={addCoin} />;
            }}
          />
          <Route
            exact
